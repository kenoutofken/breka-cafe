    ...
    <header className="fixed top-0 inset-x-0 z-50 bg-base-200">
      <nav className="mx-auto max-w-[2500px] flex justify-between items-center py-2">
        <div class="flex items-center text-primary gap-2 pl-6">
          ...
          <a className="btn btn-ghost text-primary text-xl">
            Breka Bakery and Cafe
          </a>
        </div>

        <div class="flex-none hidden md:block pr-6">
          <ul class="menu menu-horizontal font-semibold text-primary flex items-center">
            <li>
            ...
            <li>
              <button className="btn btn-primary ml-6">Order Online</button>
            </li>
          </ul>
        </div>
